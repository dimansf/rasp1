...
namespace DataMock
{
	public class Data
	{
		...
		/// <returns></returns>
		public static  (int[][], int[][]) autoGeneratedData(int lenOrders=30, int lenStores=60, int minLenObr=5, bool withoutLongMeasures=false)
		{
			var id = new[] { 40, 400, 130, 90, 70, 88, 99, 77, 78, 79, 72 };

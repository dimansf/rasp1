...
namespace DataGenerator
{
...

	{
		...
		/// </summary>
		/// <returns></returns>
		public static (string, string) GeneratePairStringOrderStore() {
			return (orders, store);
		}
		public static (int[][], int[][]) GenerateJsonOrderStore()
		{
			...
			try
			{
				...
				data1 = JsonConvert.DeserializeObject(orders);
				data2 = JsonConvert.DeserializeObject(store);
			}
			catch
			{
